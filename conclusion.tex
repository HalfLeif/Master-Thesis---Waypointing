...
For future information extraction systems that would attempt to latently associating labels with word images, this thesis provides a baseline on the Swedish population records dataset for extracting the main year.
