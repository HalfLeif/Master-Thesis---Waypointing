...
In this section we discuss traditional methods for related tasks: text recognition and word spotting. In the thesis however, we have chosen to use a different approach based on neural networks, which are discussed in depth in section \ref{sec:networks}.
