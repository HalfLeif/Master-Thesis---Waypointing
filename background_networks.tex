...
\caption{\label{fig:mlp}A multilayer perceptron with an input layer $x$, two hidden layers $u$ and $v$ as well as a readout layer $o$. Every connection uses a different weight $w$.}
\end{figure}
...
% TODO add picture of 3x3 filters
% TODO add citations
