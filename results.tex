...
% most models made many predictions that at least were in the correct decade.
% one of the models managed to guess the correct decade for $43.6\%$ of the main test set.
